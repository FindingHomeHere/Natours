...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmhoZXJlIiwiYSI6ImNramIyZzQ4ODdndTcydHBkb2F3MjF3ZjEifQ.A-FRnKJgOev5vWOldxo9rg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/fhhere/ckjb2skstaiyb19lhj6kbipqp',
...
var stripe = Stripe("pk_test_51I5HvXK5ziXiQGMFtqWiKiK0EESaBFdw4b5jPRARMuxK5GFmEiRC6fVbaSnlOIu2P0NGZsTYMcyTW7dNMHbNCy3c00FjWT1ANy");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // create checkout form + charge card
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  var passwordConfirm = document.getElementById('password-confrim').value;
